...
# Reordered filenames for ugv_parking00
# filenames = [
#     "./data/ugv_parking00/ugv_parking00_droid.txt",
#     "./data/ugv_parking00/ugv_parking00_vinfusion(lc).txt",
#     "./data/ugv_parking00/ugv_parking00_fastlio2.txt",
#     "./data/ugv_parking00/ugv_parking00_r3live.txt",
#     "./data/ugv_parking00/ugv_parking00_initialed.txt"
# ]

# Reordered filenames for vehicle_campus00
filenames = [
    "./data/vehicle_campus00/vehicle_campus00_droid.txt",
    "./data/vehicle_campus00/vehicle_campus00_vinfusion(lc).txt",
    "./data/vehicle_campus00/vehicle_campus00_fastlio2.txt",
    "./data/vehicle_campus00/vehicle_campus00_r3live.txt",
    "./data/vehicle_campus00/vehicle_campus00_initialed.txt"
]
