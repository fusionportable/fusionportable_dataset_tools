...
dataset_rostopic_msg_frameid_dict = {
  ...
  # 
  'frame_left_camera_info': ['/stereo/frame_left/camera_info', 'sensor_msgs/CameraInfo', 'frame_cam00'],
  'frame_left_image_chunk_data': ['/stereo/frame_left/image_chunk_data', 'geometry_msgs/PointStamped', 'frame_cam00'],
  'frame_left_image': ['/stereo/frame_left/image_raw/compressed', 'sensor_msgs/CompressedImage', 'frame_cam00'],
  # 
  'frame_right_camera_info': ['/stereo/frame_right/camera_info', 'sensor_msgs/CameraInfo', 'frame_cam01'],
  ...
  # 
  'unitree_body_odom': ['/unitree/body_odom', 'nav_msgs/Odometry', 'unitree_body_odom'],
  'unitree_foot_state': ['/unitree/foot_state', 'trajectory_msgs/MultiDOFJointTrajectory', 'unitree_foot'],
  'unitree_imu': ['/unitree/imu/data_raw', 'sensor_msgs/Imu', 'unitree_imu'],
  'unitree_joint_state': ['/unitree/joint_state', 'sensor_msgs/JointState', 'unitree_joint'],
  'unitree_robot_state': ['/unitree/robot_state', 'unitree_legged_msgs/HighStat', 'unitree_robot'],
  # 
