...
##handheld_escalator00 -0.64
##handheld_escalator01 -0.67
...
def main():
    ...
    for t_offset in t_offset_values:
        command = [
            'evo_ape', 'tum',
            os.path.join(FOLDER_PATH, 'resampled/handheld_escalator00_resampled.txt'),
            os.path.join(FOLDER_PATH, 'fastlio2/laptop/traj/handheld_escalator00_fastlio2.txt'),
            '-a', '--t_max_diff', '0.1', '--t_offset', str(t_offset)
        ]
        #print(command)
